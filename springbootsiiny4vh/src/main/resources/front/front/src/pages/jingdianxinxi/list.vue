		  ...
		  <div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
		    ...
		    <div :style='{"width":"100%","padding":"0 0px","overflow":"hidden","alignItems":"center","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"55%","padding":"0 0px 0 0","flex":"1"}'>
		        ...
		        <div :style='{"width":"auto","padding":"2px 10px 0 0","borderColor":"#eee","borderStyle":"dashed","borderWidth":"0 0 0px 0","display":"inline-block"}' class="like">
		          <span class="icon iconfont icon-zan10"></span>
		          <span class="text">{{item.thumbsupnum}}</span>
		        </div>
		        <div :style='{"width":"auto","padding":"2px 10px 0 0","borderColor":"#eee","borderStyle":"dashed","borderWidth":"0 0 0px 0","display":"inline-block"}' class="collect">
		          <span class="icon iconfont icon-shoucang10"></span>
		          <span class="text">{{item.storeupnum}}</span>
		        </div>
		        <div :style='{"width":"auto","padding":"2px 10px 0 0","borderColor":"#eee","borderStyle":"dashed","borderWidth":"0 0 0px 0","display":"inline-block"}' class="view">
		          <span class="icon iconfont icon-chakan9"></span>
		          <span class="text">{{item.clicknum}}</span>
		        </div>
		      </div>
		      <div class="desc" v-html="item.jingdiandizhi"></div>
		    </div>
		  </div>
		</div>
	</div>
...
<script>
  export default {
    ...
    async created() {
		...
		await this.$http.get('option/jingdianleixing/jingdianleixing').then(res => {
			if (res.data.code == 0) {
